...
template <> constexpr inline auto ARXwindow::qt_create_metaobjectdata<qt_meta_tag_ZN9ARXwindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const std::vector<double> &, const std::vector<double> &, int, double)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ARXwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ARXwindow::*)(const std::vector<double> & , const std::vector<double> & , int , double )>(_a, &ARXwindow::zatwierdzonoARX, 0))
            return;
    }
}
